...
### centrifuger classification command examples
  ...
  samtools view -f 0xC alignment.bam | samtools sort -n - | samtools fastq - | ./centrifuger -x cfr_idx --read-format bc:hd:CB:5:-1 -i - > output.tsv # unmapped read fragment from paired-end alignment BAM file generated by 10x Genomics Cellranger.
